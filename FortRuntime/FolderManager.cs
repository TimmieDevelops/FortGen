    ...
    public static class FolderManager
    {
        ...
        private static bool InjectDLL(int processId, string dllPath)
        {
            ...
            try
            {
                ...
                {
                    // Injector is 64-bit, but target is 32-bit.
                    // Find the 32-bit kernel32.dll loaded in the target process.
                    ...
                    // Parse local 32-bit kernel32.dll from SysWOW64 folder on disk to get LoadLibraryA offset.
                ...
                {
                    // Both process architectures match (both 64-bit, or both 32-bit).
