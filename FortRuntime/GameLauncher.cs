    ...
    public static class GameLauncher
    {
            ...
            if (targetFolder != null && targetExePath != null)
            {
                ...
                if (response?.Trim().ToLower() == "y")
                {
                    try
                    {
                        ...
                        {
                            string? dllPath;
                            string? lastPath = FolderManager.GetLastDllPath();
        ...
        public static void QuitGame()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("No running FortniteClient-Win32-Shipping.exe processes found.");
                    return;
                }

                Console.WriteLine($"Found {processes.Length} running process(es). Attemping to quit...");
